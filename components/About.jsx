  ...
  return (
    <div className='section about'>
      ...
      <div className='about_content'>
        ...
        <p>I was attract to software engineering after discovering the fact that everyone in this field has the mentality where  
           the sky's the limit.</p>
        <p><strong>BUT!</strong> I fell in love with it after the very first time I saw the code I wrote come to life on screen.</p>
        <p>You can either working on a project, leetcoding or working on my personal growth and mental health through reading, meal prepping, listening to podcasts and traveling.</p>
        <p>Making bold moves and solving hard problems are what drives me every day.</p> 
