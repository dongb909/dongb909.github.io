    ...
    <div className='section contact'>
      ...
      <div className="contacts_container">
        ...
        <div className="contacts_content contacts_icons">
          ...
          <div className="icon">
            <a href="https://drive.google.com/file/d/1TIEtvTNinqP_7CUPwem1vQWc_cse6xcF/view?usp=sharing">
            ...
            <a href="https://drive.google.com/file/d/1TIEtvTNinqP_7CUPwem1vQWc_cse6xcF/view?usp=sharing">Resume</a>
          </div>
        </div>
      </div>
    </div>
