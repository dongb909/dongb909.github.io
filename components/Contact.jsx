        ...
        <div className="contacts_content contacts_icons">
          ...
          <a href="https://www.github.com/dongb909">
            <svg fill="#000000" 
              ...
              viewBox="0 0 30 24" width="75" height="75">
          ...
          <div className="icon">
            <a href="#https://www.linkedin.com/in/dongb909">
              <svg fill="#000000" 
                xmlns="http://www.w3.org/2000/svg" 
                viewBox="0 0 46 46" width="75" height="65">
          ...
          <div className="icon">
            <svg height="60" viewBox="0 0 24 24" width="70" 
            xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="icon">
            <svg version="1.1" 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 550 550" width="70" height="60" >
          ...
          <div className="icon">
            <a href="https://drive.google.com/file/d/1Zdy-L8ooQjvsWdeEy5Zj6VuiuioKT_AM/view?usp=sharing">
              <svg height="60" viewBox="0 0 500 500" width="70" 
                xmlns="http://www.w3.org/2000/svg">
